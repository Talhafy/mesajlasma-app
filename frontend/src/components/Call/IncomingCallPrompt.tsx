      ...
      <div className="incoming-call-card">
        ...
        <div className="incoming-call-copy">
          <div className="incoming-call-label">
            {call.callType === 'video' ? 'Görüntülü çağrı' : 'Sesli çağrı'}
          </div>
          <h2>{title}</h2>
          <p>{call.caller.username} arıyor</p>
        </div>
        <div className="incoming-call-actions">
          <button className="incoming-call-button decline" onClick={onDecline} title="Reddet">
            <svg viewBox="0 0 24 24" width="24" height="24" fill="currentColor" aria-hidden="true">
              <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1C10.61 21 3 13.39 3 4c0-.55.45-1 1-1h3.49c.55 0 1 .45 1 1 0 1.24.2 2.45.57 3.57.11.35.03.74-.25 1.02z" />
            </svg>
          </button>
