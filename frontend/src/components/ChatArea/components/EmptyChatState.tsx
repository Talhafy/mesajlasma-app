/**
 * ============================================================================
 * BOŞ SOHBET DURUMU BİLEŞENİ (EmptyChatState Component)
 * ============================================================================
 * 
 * Bu bileşen, henüz sol listeden herhangi bir kişi veya sohbet seçilmediğinde
 * ana sohbet alanında (ChatArea) görüntülenen karşılama/boş durum ekranıdır.
 * 
 * ÖZELLİKLER:
 * 1. Thunder marka logosu SVG animasyonu
 * 2. Karşılama metni ve kullanıcı yönlendirmesi
 * 3. Tema renklerine duyarlı dinamik stil yapısı
 */
...
export default function EmptyChatState({ panelBg, textColor, iconColor }: EmptyChatStateProps) {
  return (
    <div className="chat-area empty-chat-state" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1, backgroundColor: panelBg }}>
      ...
      {/* MESAJLAŞMAYA BAŞLA KARŞILAMA YAZISI */}
